(function() {
  ...
  function n(a) {
    ...
    this.m &&
      ...
      this.b([this.c + "_setCampIdKey", "cid"]),
      -1 == a.indexOf("utm_campaign=") &&
        this.b([this.c + "_setCampNameKey", "sourceid"]),
      -1 == a.indexOf("utm_medium=") &&
        this.b([this.c + "_setCampMediumKey", "medium"]),
      -1 == a.indexOf("utm_source=") &&
        this.b([this.c + "_setCampSourceKey", "subid"]),
      -1 == a.indexOf("utm_term=") &&
        this.b([this.c + "_setCampTermKey", "term"]),
      -1 == a.indexOf("utm_content=") &&
        this.b([this.c + "_setCampContentKey", "content"]));
    ...
    if (this.e)
      for (a = 0, c = this.e.length; a < c; a++)
        0 > this.g.indexOf(this.e[a]) &&
          this.b([this.c + "_cookiePathCopy", this.e[a]]);
    this.a.disableTrackPageview ||
      ((a = this.a.pageviewPath),
      a ||
        ((a = this.prefix + this.pathname),
        this.n && (a += window.location.search)),
    ...
    (this.d = this.a.trackEventCallback) &&
          ...
          if (
            Boolean(
              "a" == b.nodeName.toLowerCase() ||
                b.getAttribute("data-g-event") ||
                b.getAttribute("data-g-action") ||
                b.getAttribute("data-g-label")
            )
          ) {
      ...
      ? b.getAttribute("data-g-event") ||
          ...
          ("a" == b.tagName.toLowerCase()
            ? b.hostname == window.location.hostname
              ? "AutoTrack: Link Click"
              : "AutoTrack: Outbound Click"
            : "AutoTrack: Element Click")
      : "action" == c
        ? b.getAttribute("data-g-action") ||
          d(a.i) ||
          b.getAttribute("href") ||
          "AutoTrack: Element Click"
        : "label" == c
          ? b.getAttribute("data-g-label") || d(a.k) || a.pathname
          : "";
  }
  function q(a, c, b, d) {
    d && (b = m(b, d));
  ...
  function p(a, c, b) {
    ...
    if (document.addEventListener)
      ...
      var e = document.createElement("tempnode"),
      ...
      "readyState" in document
        ? (k = window.setInterval(function() {
            /loaded|complete/.test(document.readyState) &&
              (window.clearInterval(k), (k = null), b && (c = m(c, b)), c());
          }, 50))
        : q(window, "load", c, a);
  }
